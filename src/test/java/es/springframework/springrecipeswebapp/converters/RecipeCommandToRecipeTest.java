...
class RecipeCommandToRecipeTest {
    ...
    public void convert() throws Exception {
        ...
        recipeCommand.setCookingTime(COOK_TIME);
        recipeCommand.setPreparationTime(PREP_TIME);
        recipeCommand.setDescription(DESCRIPTION);
        recipeCommand.setDifficulty(DIFFICULTY);
        recipeCommand.setDirections(DIRECTIONS);
        recipeCommand.setNumberServings(SERVINGS);
        ...
        assertEquals(COOK_TIME, recipe.getCookingTime());
        assertEquals(PREP_TIME, recipe.getPreparationTime());
        assertEquals(DESCRIPTION, recipe.getDescription());
        assertEquals(DIFFICULTY, recipe.getDifficulty());
        assertEquals(DIRECTIONS, recipe.getDirections());
        assertEquals(SERVINGS, recipe.getNumberServings());
